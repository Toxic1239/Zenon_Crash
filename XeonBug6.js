...
╭𝗗𝗥𝗔𝗞𝗘𝗡 𝗠𝗗 𝗕𝗨𝗚 𝗕𝗢𝗧 ❒
║𝗨𝗦𝗘𝗥     〣  ${pushname}
║𝗢𝗪𝗡𝗘𝗥     〣  ${global.ownername} 
║𝗕𝗢𝗧 𝗡𝗔𝗠𝗘 〣 ${global.botname}
║𝗣𝗟𝗨𝗚𝗜𝗡𝗦 〣 𝟵𝟵 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦
║𝗣𝗥𝗘𝗙𝗜𝗫   〣 ${global.prefa}
║𝗨𝗣𝗧𝗜𝗠𝗘  〣 ${runtime(process.uptime())}
╰𝗠𝗔𝗗𝗘 𝗕𝗬 𝗧𝗢𝗫𝗫𝗜𝗖 𝗕𝗢𝗬 ❒
▽▽▽▽▽▽▽▽▽▽▽▽
𝑯𝑬𝑹𝑬 𝑰𝑺 𝑴𝒀 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺.. ×͜×
${readmore}
╭═══❂ 𝗔𝗡𝗗𝗥𝗢𝗜𝗗 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xᴀɴᴅʀɪᴏᴅ [ɴᴜᴍʙᴇʀ,ᴀᴍᴏᴜɴᴛ]*
┃ ❏ *xᴀɴᴅʀɪᴏᴅ2 [ᴀᴍᴏᴜɴᴛ]*
┃ ❏ *sʏsᴛᴇᴍᴜɪᴄʀᴀsʜ [ɴᴜᴍʙᴇʀ,ᴀᴍᴏᴜɴᴛ]*
