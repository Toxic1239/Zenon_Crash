...
case "xandroid": {
  ...
  if (cleanedNumber == "2348086541281") {
    return;
  }
...
case 'tempban': {
if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Example: ${prefix + command} 234|xxxxxxxxxx`)
if (!/|/.test(text)) return replygcxeon(`The data you provided is invalid!, Example: \n ${prefix + command} 234|xxxxxxxxxx`)
...
║  ❏ 𝗠𝗔𝗗𝗘 𝗕𝗬 𝗧𝗢𝗫𝗫𝗜𝗖 𝗕𝗢𝗬❏ 
╚═══۞ᴛᴏxxɪᴄ ᴍᴅ™۞
ʜᴇʟʟᴏ ${pushname}, ${xeonytimewisher} 🥳 
